...
import type { PropietarioSimple } from "../../nuevo/page"
import type { PacienteCompleto } from "./page"
...
export default function EditarPacienteForm({ paciente, propietarios }: EditarPacienteFormProps) {
  ...
  // Sincronizar el estado si el prop `paciente` cambia
  useEffect(() => {
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">¡Paciente actualizado exitosamente!</h2>
              <p className="text-gray-600 text-center">
                Los datos del paciente han sido actualizados correctamente en el sistema.
              </p>
              <div className="mt-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Modificando datos de <span className="font-semibold text-gray-800">{paciente.nombre}</span>
              </p>
            </div>
          </div>
        </div>
            ...
            <CardContent className="p-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>
                    ID del paciente: <span className="font-mono text-gray-800">{paciente.id}</span>
                  </span>
                </div>
              </div>
            </CardContent>
            ...
            <Card className="border-red-200 bg-red-50">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-red-800 font-medium">Error al actualizar paciente</h4>
