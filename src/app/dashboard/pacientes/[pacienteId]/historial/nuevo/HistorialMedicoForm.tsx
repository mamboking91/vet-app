...
import { Calendar, FileText, Stethoscope, Pill, AlertCircle, Save, X, Plus } from "lucide-react"
...
const tiposRegistroMedicoOpciones = [
  ...
  { value: "Procedimiento", label: "Procedimiento", icon: Stethoscope },
  ...
  { value: "Cirugía", label: "Cirugía", icon: Stethoscope },
